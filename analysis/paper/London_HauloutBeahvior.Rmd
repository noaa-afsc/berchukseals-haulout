...
p <- ggplot() +
  ...
  scale_fill_manual(values = species_colors,
                    aesthetics = "fill", 
                    name = "species") + 
  labs(caption = "<span style = 'color: #A26E7C;'><span style = 'font-family: \"Font Awesome 6 Free Regular\";'>&#xf0c8;</span> spatial extent of aerial survey effort in US waters</span>") +
...
ggplot(data = seal_hours_tbl, aes(x = yday, y = n, fill = n))+
  ...
  theme(axis.text.x = element_text(hjust = 0),
        strip.text.x = element_text(hjust = 0, margin=margin(l=15)),
