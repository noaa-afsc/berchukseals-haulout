...
abundance from large scale surveys of these species are unknown, so it is
...
sea-ice but also within snow lairs. The remoteness of the Bering and Chukchi
seas mean direct scientific observation of seal behavior is impractical. Thus,
bio-logging devices are especially useful tools for collecting key information
on movement and haul-out behavior for these species.
...
previously described by Kelly and Quakenbush [-@kelly1990c] using VHF radio tags and
...
walruses [@udevitz2009]. Third, we assessed the annual variability
...
fallen off or their batteries are depleted.
...
distribution of weighted locations with available haul-out behavior data for each
...
wind consisting of northerly and easterly vector components converted to wind
speed using the Euclidean norm, 3) barometric pressure at sea level, and 4)
precipitation (Table \@ref(tab:tblCovariates)).
...
ribbon and spotted seal models because, during the spring, these species are most
...
probability surfaces (see figures \@ref(fig:beardedHOCal), \@ref(fig:ribbonHOCal), and
\@ref(fig:spottedHOCal)), explore conditional effects of weather covariates, and
...
shown for all ages. Overall, bearded seals were less likely to haul out and had
a bi-modal distribution of haul-out probability across the day (Figure
...
In concert with the lower magnitude of haul-out probability, bearded seal
haul-out behavior is also more protracted throughout the spring season compared
to ribbon and spotted seals.
...
```{r beardedHOwx, fig.height = 5.5, include=TRUE, fig.cap="Marginal effects of temperature, wind, pressure, and accumulated precipitation on the predicted haul-out probability of bearded seals combined across all age and sex classifications. Hour of the day was fixed at local solar noon and day-of-year held at the day of peak haul-out for bearded seals. Transparent vertical lines represent the 95\\% confidence interval around the predicted haul-out probability."}
...
```{r spottedHOwx,fig.height = 5.5, include=TRUE, fig.cap="Marginal effects of temperature, wind, pressure, and accumulated precipitation on the predicted haul-out probability of spotted seals within each age and sex classification. Hour of the day was fixed at local solar noon and day-of-year held at the average day of peak haul-out for spotted seals. Transparent vertical lines represent the 95\\% confidence interval around the predicted haul-out probability."}
...
species, age, and sex that match our understandinf of their
ecological behavior. Spotted seals are known to form triads during the breeding
season where a female and dependent pup are accompanied on the ice by a suitor
male [@frost2018]. The male waits for the female to wean the pup and enter
...
and a protracted spring haul-out season for both sexes. While females are still
nursing the pup and not yet in estrus they may be less inclined to interrupt
their haul out and enter the water where the suitor male would attempt mating.
We see this reflected in the predicted haul-out behavior, with both males and
females exhibiting a broad distribution of time out of the water throughout the
solar day and the season. Ribbon seals are not known to form triads and our
model predicts a progression of increased haul-out behavior with females
starting earlier in the season than males. Notably, female ribbon seals spend a
large portion of the day in the water during the pupping period, aligning with
the hypothesis that ribbon seal females continue foraging while nursing.
Subadult ribbon and spotted seals begin consistent haul-out behavior earlier and
follow a pattern seen in other phocids where yearlings and subadults molt first
followed by adult females and males [@reder2003, @thompson1987, @kirkman2003].
...
weather, with wind, temperature, and barometric pressure all
...
provide better predator detection conditions. Our results highlight the
...
ice, seals will not haul out or be forced to use terrestrial haul-out sites.
...
J.R. Leavitt, and Joe Skin from Utqiaġvik, Alaska; Mary Ellen Ahmaogak, Enoch Oktollik, Shawn
