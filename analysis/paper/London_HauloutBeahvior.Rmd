...
p <- ggplot() +
  ...
  labs(title = "Initial bio-logger deployment locations by species",
       ...
       caption = "outlined region indicates spatial extent of aerial survey effort in US waters") +
  theme(legend.position = "none",
        axis.title = element_blank(),
        strip.background = element_blank(),
        strip.placement = "outside",
        strip.text.x = element_markdown(face = "bold"),
        plot.caption = element_markdown(color = "#A26E7C")
  )
...
ggplot() +
  ...
  labs(
    ...
    caption = bquote("One hexagonal cell represents 50" ~ km ^ 2)
  ) +
  theme(
...
p <-
  ...
  labs(title = "Annual variability in the timing of peak haul-out probability",
       subtitle = "Predictions for ribbon and spotted seals are shown for local 
       solar noon and under smoothed weather conditions") +
...
yearly maximum sea ice extent in the study area. Adult female and subadult spotted seals
