...
abstract: >
  ...
  ringed seals (_Phoca (pusa) hispida_) can be out of the water but hidden from view in
...
summer [@frost2018]. Ringed seals (_Phoca (pusa) hispida_) --- not included in this
...
intervals based on the original grid resolution of 32 km (1024 km^2^). The
