...
(ref:deployMapCaption) Initial deployment areas for each seal species (bearded, ribbon, and spotted seals) in the study between 2005 and 2020. Deployments were initiated across a range of months but only data from 1 March to 15 July were included in the analysis. See Figure \@ref(fig:dataMap) for the spatial distribution of observed data used in the study.
...
p <- ggplot() +
  ...
  ggtitle("Areas of initial deployment location",
          subtitle = 
                ...
                "and ", 
                "<span style = 'color:",species_colors['Spotted seal'],";'>spotted seals</span> ", 
                "across multiple regions within the Bering and Chukchi seas.")) +
