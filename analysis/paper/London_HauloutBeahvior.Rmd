...
all assigned an error radius of 50m. On days when haul-out observations were
...
3-hr intervals based on the native grid resolution of 32km (1024km^2^). The
...
locations using a bilinear method: 1) air temperature at 2m above the earth's
...
barometric pressure. And, for bearded seals, the model indicated wind and
