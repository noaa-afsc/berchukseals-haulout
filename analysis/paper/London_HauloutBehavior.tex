...
\multicolumn{1}{>{\raggedright}m{\dimexpr 0.9in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{Spotted\ seal}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 0.4in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{F}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 1.35in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{23\ (21,588\ seal\ hours)}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 1.35in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{21\ (19,559\ seal\ hours)}}} & \multicolumn{1}{>{\raggedright}m{\dimexpr 1.35in+0\tabcolsep}}{\textcolor[HTML]{000000}{\fontsize{9}{9}\selectfont{11\ (13,417\ seal\ hours)}}} \\
...
(GLMPMs; (Ver Hoef, London \& Boveng, 2010)) to model variation in haul-out behavior as a function
...
We used the glmmLDTS package (Ver Hoef, London \& Boveng, 2010) to implement GLMPMs. We explored
...
\begin{figure}
\includegraphics[width=1\linewidth]{../figures/annualHO-1} \caption{\textbf{Annual variability in the timing of peak haul-out probability for ribbon and spotted seals.} \linebreak Spring haul-out probability (colored markers) for ribbon and spotted seals across 14 years are shown. The full seasonal range of annual predictions along with uncertainty are presented as grey lines. Covariates were fixed at local solar noon and under smoothed weather conditions. Only those groups (age:sex + year) that included observations from more than one seal are shown. Additionally, any groups where data were only available after 1 June or before 1 May are not included.}\label{fig:annualHO}
\end{figure}
...
\leavevmode\vadjust pre{\hypertarget{ref-bengtson2004}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-bengtson2005a}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-betts2006}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-boveng2009}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-boveng2013a}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-boveng2013}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-boveng2018a}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-boveng2020}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-breed2018}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-bronson2009}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-cameron2010}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-cameron2018}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-cavalieri1996}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-conn2014a}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-conn2012c}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-conn2023}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-crawford2019}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-crawford2015}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-frost2004}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-hamilton2018}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-harwood2020}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-huntington2020}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-johnson2008a}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-kelly2010}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-kelly1990c}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-kirkman2003}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-kwok2018}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-lindsay2021}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-london2012}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-lonergan2013}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-lopez2013}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-mclaren1958a}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-mesinger2006a}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-niemi2023}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-olnes2020}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-overland2021}{}}%
Overland JE. 2021. Rare events in the Arctic. \emph{Climatic Change} 168:1--13.

\leavevmode\vadjust pre{\hypertarget{ref-perpinan2012}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-perry2017}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-reder2003}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-southwell2008}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-thometz2021}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-thompson1987}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-udevitz2009}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-verhoef2014a}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-verhoef2010a}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-vonduyke2020}{}}%
...
\hypertarget{additional-bio-logger-deployment-details}{%
...
\hypertarget{supplemental-figures-showing-confidence-intervals-associated-with-predictions}{%
...
\begin{figure}
\includegraphics[width=1\linewidth]{../figures/beardedPredSE-1} \caption{Seasonal variability in haul-out probability and the associated 95\% confidence intervals (shaded area) for bearded seals. Model predictions are shown for three local solar hours (07:00, 12:00, and 17:00) with smoothed weather covariates. Age and sex classes are combined into a single 'all ages' category.}\label{fig:beardedPredSE}
\end{figure}

\begin{figure}
\includegraphics[width=1\linewidth]{../figures/ribbonPredSE-1} \caption{Seasonal variability in haul-out probability and the associated 95\% confidence intervals (shaded area) for ribbon seals. Model predictions are shown for three local solar hours (07:00, 12:00, and 17:00) with smoothed weather covariates. Age and sex classes are separated to allow comparisons.}\label{fig:ribbonPredSE}
\end{figure}

\begin{figure}
\includegraphics[width=1\linewidth]{../figures/spottedPredSE-1} \caption{Seasonal variability in haul-out probability and the associated 95\% confidence intervals (shaded area) for spotted seals. Model predictions are shown for three local solar hours (07:00, 12:00, and 17:00) with smoothed weather covariates. Age and sex classes are separated to allow comparisons.}\label{fig:spottedPredSE}
\end{figure}
...
physiology and expected behavioral changes. The ERA5's \emph{surface solar radiation downwards}
