...
behavior varied among years. There was no support linking the variability in haul-out
timing to annual sea ice extent. Our analysis also emphasizes the importance of accounting
for weather factors affecting haul-out behavior when interpreting the number of seals
...
year$\times$day3 interactions as models with the latter effects were numerically unstable.
...
haul-out behavior was further used to regress against the annual maximum sea ice extent in
the study region.
