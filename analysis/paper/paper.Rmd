...
such, start and end times of each deployment were identified by experts who examined several
...
by a wind $\times$ temperature interaction; [@udevitz2009cjz]), together with day-of-year
...
We did explore whether the annual variation in maximum spring sea ice extent in the Bering
...
covariates included within the model except precipitation. The impact of temperature
...
`r ribbon_type3$pressure$F.value`; $p$ = `r ribbon_type3$pressure$Prob.F`) was especially
...
female and subadult spotted seals show a negative trend line but no indication that the
observed trend is meaningful (spotted seal adult female: $R^{2}$ =
...
spring, and with peak use near mid-May to early June before declining again. This pattern
...
a suitor male. The male is waiting for the female to wean the pup and enter estrus and
fending off any other males that may be interested. Triad formation results in both males
...
less inclined to venture out for foraging trips while still nursing the pup. We can see a
clear reflection of this in the predicted haul-out behavior with both males and females
exhibiting a broad distribution of time out of the water throughout the solar day and the
season. Ribbon seals are not known to form triads and our model predicts a progression of
...
begin meaningful haul-out behavior and reflects a typical phocid pattern where subadults
...
our knowledge have never been investigated for ice-associated seals. Ribbon seals seem to
...
data are prepared prior to analysis. 
