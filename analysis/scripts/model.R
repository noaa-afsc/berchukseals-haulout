...
HO_ribbon %>% filter(across(everything(), ~ is.na(.x)))

fit_ribbon <- glmmLDTS(fixed.formula = dry ~ age_sex + sin1 + cos1 + sin2 + cos2 + sin3 + cos3 + day + day2+ day3 + temp2 + wind + pressure + precip + wind*temp2 +
...
# check that there are no NAs
HO_spotted %>% filter(across(everything(), ~ is.na(.x)))

fit_spotted <- glmmLDTS(fixed.formula = dry ~ age_sex + sin1 + cos1 + sin2 + cos2 + sin3 + cos3 + day + day2+ day3 + temp2 + wind + pressure + precip + wind*temp2 +
                         sin1*day + cos1*day + sin2*day + cos2*day + sin3*day + cos3*day +
                         sin1*day2 + cos1*day2 + sin2*day2 + cos2*day2 + sin3*day2 + cos3*day2 +
                         age_sex:day + age_sex:day2 + age_sex:day3,
                       random.formula = dry ~ speno,
...
# check that there are no NAs
HO_bearded %>% filter(across(everything(), ~ is.na(.x)))

fit_bearded <- glmmLDTS(fixed.formula = dry ~ sin1 + cos1 + sin2 + cos2 + sin3 + cos3 + day + day2+ day3 + northing + temp2 + wind + pressure + precip + wind*temp2 +
                          sin1*day + cos1*day + sin2*day + cos2*day + sin3*day + cos3*day +
                          sin1*day2 + cos1*day2 + sin2*day2 + cos2*day2 + sin3*day2 + cos3*day2 +
...
save(fit_bearded, file = here::here('data/fit_bearded.Rdata'))
